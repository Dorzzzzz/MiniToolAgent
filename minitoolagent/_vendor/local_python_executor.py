...
# Vendored from smolagents — Apache License 2.0
# Source: https://github.com/huggingface/smolagents/blob/main/src/smolagents/local_python_executor.py
# Local edits: stripped two intra-package imports (.tools.Tool, .utils);
#   inlined BASE_BUILTIN_MODULES and truncate_content; loosened Tool type hint to Any.
...
# Inlined from smolagents/src/smolagents/utils.py
